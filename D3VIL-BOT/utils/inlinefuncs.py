...
from D3VIL-BOT import arq
from D3VIL-BOT.core.keyboard import Ikb
from D3VIL-BOT.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from D3VIL-BOT.core.tasks import _get_tasks_text, all_tasks, rm_task
from D3VIL-BOT.core.types.__init__ import InlineQueryResultCachedDocument
from D3VIL-BOT.modules.info import get_chat_info, get_user_info
from D3VIL-BOT.modules.music import download_youtube_audio
from D3VIL-BOT.utils.functions import test_speedtest
from D3VIL-BOT.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/d1add7372ef0893bcca32.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/Miss_AkshiV1_Bot"),
        InlineKeyboardButton(
...
**Profiles:** [BOT](t.me/Miss_AkshiV1_Bot) | [UBOT](https://t.me/Professer_Ashu)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
...
async def music_inline_func(answers, query):
    chat_id =  -1001678954822
    group_invite = "https://t.me/+9sNFQWMmlUA4ZTNh"
    try:
        messages = [
            m
