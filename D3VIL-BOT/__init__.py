...
if ENV:
    ...
    from D3VIL-BOT.config import Development as Config
...
pbot = Client("D3VIL-BOT", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from D3VIL-BOT.modules.helper_funcs.handlers import (
