...
from D3VIL-BOT.pyrogramee.pluginshelper import member_permissions

from D3VIL-BOT.mongo import db
...
regex_upvote = r"^((?i)\+|\+\+|\+1|thx|tnx|ty|thank you|thanx|thanks|pro|cool|good|👍|OwO|ÒwÓ|Piro|op|noice)$"

regex_downvote = r"^(\-|\-\-|\-1|👎|bhkk|nub|ÕwÕ|Nezuko is my waifu)$"
