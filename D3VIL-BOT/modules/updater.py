...
from D3VIL-BOT import HEROKU_APP_NAME, HEROKU_API_KEY, OWNER_ID

UPSTREAM_REPO_URL = get_str_key("UPSTREAM_REPO_URL", None)
if not UPSTREAM_REPO_URL:
    UPSTREAM_REPO_URL = "https://github.com/darkphoenix2601/Miko_bot"
...
async def upstream(ups):
    ...
    if conf == "deploy":
        ...
        await lol.edit("`Successfully Updated!\n" "restarting......`")
        args = [sys.executable, "-m", "D3VIL-BOT"]
