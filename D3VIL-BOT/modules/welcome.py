...
import D3VIL-BOT.modules.sql.welcome_sql as sql
import D3VIL-BOT
...
from D3VIL-BOT.modules.helper_funcs.misc import build_keyboard, revert_buttons
from D3VIL-BOT.modules.helper_funcs.msg_types import get_welcome_type
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "WOW Selamat datang 𝙇𝙊𝙍𝘿 𝙁𝙄𝙕𝙄.\n\n• @Professor_Ashu", reply_to_message_id=reply
                )
                welcome_log = (
