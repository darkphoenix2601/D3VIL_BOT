...
import D3VIL-BOT.modules.sql.notes_sql as sql
from D3VIL-BOT import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from D3VIL-BOT.__main__ import DATA_IMPORT
from D3VIL-BOT.modules.helper_funcs.chat_status import user_admin
from D3VIL-BOT.modules.helper_funcs.alternate import typing_action

# from D3VIL-BOT.modules.rules import get_rules
import D3VIL-BOT.modules.sql.rules_sql as rulessql

# from D3VIL-BOT.modules.sql import warns_sql as warnssql
import D3VIL-BOT.modules.sql.blacklist_sql as blacklistsql
from D3VIL-BOT.modules.sql import disable_sql as disabledsql

# from D3VIL-BOT.modules.sql import cust_filters_sql as filtersql
# import D3VIL-BOT.modules.sql.welcome_sql as welcsql
import D3VIL-BOT.modules.sql.locks_sql as locksql
from D3VIL-BOT.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("D3VIL-BOT{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("D3VIL-BOT{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `D3VIL-BOT-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("D3VIL-BOT{}.backup".format(chat_id))  # Cleaning file
